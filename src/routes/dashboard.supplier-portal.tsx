...
import { Mail, CheckCircle2, XCircle, Pencil, Paperclip, Building2, Clock } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Vista simulada del portal donde el proveedor responde a las solicitudes de descuento puntual (Aprobar / Rechazar / Modificar %).
        </p>
      </div>
