...
const approvers: Approver[] = [
  ...
  },
  {
    ...
    id: "80345678",
    direction: "Electrodomésticos",
    division: "Refrigeración",
    active: true,
    email: "andres.ramirez@corbeta.com",
    phone: "3145678901",
    manager: "Roberto Díaz",
    zone: "Bogotá Sur",
    unit: "Bogotá Sur",
    ...
    scopes: [
      { code: "SC-030", description: "Aprobación descuentos línea Refrigeración", limit: "9%", status: "Activo" },
    ],
  },
  {
    ...
    division: "Móviles",
    active: true,
    email: "carolina.herrera@corbeta.com",
    phone: "3156789012",
    manager: "Ana Ruiz",
    zone: "Barranquilla",
    unit: "Atlántico",
    ...
    scopes: [
      { code: "SC-031", description: "Aprobación descuentos línea Móviles", limit: "7%", status: "Activo" },
    ],
  },
  {
    name: "Javier Torres",
    ...
    division: "Cocina",
    active: true,
    email: "javier.torres@corbeta.com",
    phone: "3167890123",
    manager: "Carlos Vega",
    zone: "Medellín",
    unit: "Antioquia Sur",
    ...
    scopes: [
      { code: "SC-032", description: "Aprobación descuentos línea Cocina", limit: "10%", status: "Activo" },
    ],
  },
  {
    name: "Diana Castro",
    id: "52987654",
    direction: "Línea Blanca",
    division: "Lavado",
    active: true,
    email: "diana.castro@corbeta.com",
    phone: "3178901234",
    manager: "Roberto Díaz",
    zone: "Bogotá Norte",
    unit: "Bogotá Norte",
    ...
    scopes: [
      { code: "SC-033", description: "Aprobación descuentos línea Lavado", limit: "11%", status: "Activo" },
    ],
  },
  {
    name: "Felipe Moreno",
    id: "1020345678",
    direction: "Tecnología",
    division: "Audio y Video",
    active: false,
    status: "Inactivo",
    email: "felipe.moreno@corbeta.com",
    phone: "3189012345",
    manager: "Ana Ruiz",
    zone: "Cali",
    unit: "Valle",
    ...
    scopes: [
      { code: "SC-034", description: "Aprobación descuentos línea Audio y Video", limit: "8%", status: "Pendiente" },
    ],
  },
  {
    name: "Valentina Ríos",
    ...
    division: "Muebles",
    active: true,
    email: "valentina.rios@corbeta.com",
    phone: "3190123456",
    manager: "Carlos Vega",
    zone: "Bucaramanga",
    unit: "Santander",
    ...
    scopes: [
      { code: "SC-035", description: "Aprobación descuentos línea Muebles Premium", limit: "6%", status: "Activo" },
    ],
  },
  {
    name: "Sebastián López",
    id: "1012345678",
    direction: "Lubricantes",
    division: "Automotriz",
    active: true,
    status: "Pendiente",
    email: "sebastian.lopez@corbeta.com",
    phone: "3201234567",
    manager: "Mónica Patiño",
    zone: "Bogotá Sur",
    unit: "Bogotá Sur",
    startDate: "2023-02-14",
    scopes: [
      { code: "SC-036", description: "Aprobación descuentos línea Lubricantes", limit: "5%", status: "Pendiente" },
    ],
  },
  {
    name: "Natalia Vargas",
    id: "63456789",
    direction: "Electrodomésticos",
    division: "Pequeños Electrodomésticos",
    active: true,
    email: "natalia.vargas@corbeta.com",
    phone: "3212345678",
    manager: "Roberto Díaz",
    zone: "Pereira",
    unit: "Eje Cafetero",
    ...
    scopes: [
      { code: "SC-037", description: "Aprobación descuentos PAE", limit: "9%", status: "Activo" },
    ],
  },
  {
    name: "Ricardo Gómez",
    ...
    division: "Computación",
    active: true,
    email: "ricardo.gomez@corbeta.com",
    phone: "3223456789",
    manager: "Ana Ruiz",
    zone: "Bogotá Norte",
    unit: "Bogotá Norte",
    ...
    scopes: [
      { code: "SC-038", description: "Aprobación descuentos corporativos Cómputo", limit: "14%", status: "Activo" },
    ],
  },
  {
    name: "Paola Jiménez",
    ...
    division: "Decoración",
    active: true,
    email: "paola.jimenez@corbeta.com",
    phone: "3234567890",
    manager: "Carlos Vega",
    zone: "Cartagena",
    unit: "Bolívar",
    ...
    scopes: [
      { code: "SC-039", description: "Aprobación descuentos línea Decoración", limit: "7%", status: "Activo" },
    ],
  },
  {
    ...
    division: "Cocción",
    active: true,
    email: "mauricio.pineda@corbeta.com",
    phone: "3245678901",
    manager: "Roberto Díaz",
    zone: "Medellín",
    unit: "Antioquia Centro",
    ...
    scopes: [
      { code: "SC-040", description: "Aprobación descuentos línea Cocción", limit: "10%", status: "Activo" },
    ],
  },
];
